...
class Propagation:
    ...
    def __init__(self, RGBimg, Depthimg, f=1, angleX=0, angleY=0,
                 Red=639*nm, Green=525*nm, Blue=463*nm, SLM_width=3840,
    ...
    def Prop(self, color, image, amap, n):
        ...
        result *= refwave(wvl, self.w, self.h, self.pp, self.thetaX, self.thetaY)
        return result
...
if __name__ == '__main__':
    fs = Propagation('cubes.bmp', 'cubes_depth.bmp')
    dimg = fs.img_B
    print(dimg.shape)
